...
int numCirculos = 0;
int numElipses = 0;
vector<string> arr_opcion = {"Salirrrrrrrrrr", "Agregar figura", "Glosario de formas", "Leer de un fichero","Total Areas"};
EllipseContainer eliContainer;
    ...
    do {
        ...
        switch (opcion) {
            ...
            case 4:
                ...
                break;
            case 5:
                //Mostrar el total de Areas del vector
                
                cout<<"El total de Areas es:"<<eliContainer.getAreas()<<"\n";
                break;
